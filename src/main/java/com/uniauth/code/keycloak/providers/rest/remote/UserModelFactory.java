...
import static com.uniauth.code.keycloak.providers.rest.ConfigurationProperties.*;
...
public class UserModelFactory {
    ...
    private Optional<RoleModel> getRoleModel(RealmModel realm, String role) {
        ...
        return Optional.ofNullable(Optional.ofNullable(Optional.ofNullable(realm.getRole(role))
                .orElseGet(() -> realm.getClientsStream()
